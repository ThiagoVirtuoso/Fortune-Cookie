...
const button = document.querySelector('#openAnother')
const fortuneLabel = document.querySelector('.fortune-message p')
const fortuneMessages = [
  ...
  'O que empobrece o ser humano, não é a falta de dinheiro, mas sim, a falta de motivação e criatividade.',
...
function openCookie() {
  ...
  let randomFortuneMessage = fortuneMessages[Math.floor(Math.random() * fortuneMessages.length)]
  fortuneLabel.innerText = randomFortuneMessage
}
...
button.addEventListener('click', openAnother)
